...
FadianNet骨干网是公益的，大家共同维护不收费。但是FadianRoam作为业务层，如果某个站点注册了一大堆用户、跑了巨大的流量、甚至拿来做商业WiFi服务——那你就需要承担相应的网络成本了。

默认情况下每个站点有一个合理使用的额度（免费），如果需要更高速率或者更大用量，流程是：

1. 向 [YunZheng HelpCentre](https://helpdesk.yunzheng.space) 提交工单
2. 治理委员会（目前就是维护者）审核
3. 评估对FadianNet基础设施的影响
4. 批准后可能涉及费用和商业计划

商业使用的话就更严格了，需要在申请加入的时候就声明商业意图。
